...
class LoginActivityMVC : AppCompatActivity() {
                ...
                APIClient.instance.instanceRetrofit(WanAndroidAPI::class.java)
                    ...
                    .subscribe(object : APIResponse<LoginResponse>(this) {
                        override fun success(data: LoginResponse?) {
                            ...
                            Toast.makeText(this@LoginActivityMVC, "登录成功😀", Toast.LENGTH_SHORT).show()
                        }
                        override fun failure(errMsg: String?) {

                            Toast.makeText(this@LoginActivityMVC, "登录失败 ~ 呜呜呜", Toast.LENGTH_SHORT)
                                .show()
                        }
